        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Booking_Time = table.Column<string>(type: "text", nullable: false),
                    BookingDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    Stay_Days = table.Column<int>(type: "integer", nullable: false),
                    Total_Price = table.Column<decimal>(type: "numeric", nullable: false),
                    Remaining_Amount = table.Column<decimal>(type: "numeric", nullable: false),
                    Status = table.Column<string>(type: "text", nullable: false),
                    CurrencyCode = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false, defaultValue: "YER"),
                    CurrencySymbol = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false, defaultValue: "YR"),
                    Guest_Notes = table.Column<string>(type: "text", nullable: false),
                    Booking_Confirmed = table.Column<bool>(type: "boolean", nullable: false),
                    Booking_Source = table.Column<string>(type: "text", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_Type = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    Id_Issuing_Country = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppGuestRegistries", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AppHotelSettingsDocuments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SettingsPassword = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    HotelImageDataUrl = table.Column<string>(type: "text", nullable: true),
                    ProfileJson = table.Column<string>(type: "text", nullable: false),
                    CurrencyId = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    CurrencySymbol = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: true),
                    CurrencyCode = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppHotelSettingsDocuments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "text", nullable: false),
                    MaintenanceReason = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppRoomTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppGuestRegistries_Id_Number",
