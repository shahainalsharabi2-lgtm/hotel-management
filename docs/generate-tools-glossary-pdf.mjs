/**
 * يولّد PDF لدليل أدوات ومصطلحات المشروع (أزرار، مكوّنات Angular، خدمات، إلخ)
 * التشغيل: node docs/generate-tools-glossary-pdf.mjs
 */
...
const htmlPath = join(__dirname, 'tools-glossary-ar.html');
const pdfPath = join(__dirname, 'Hotel-Tools-Glossary-AR.pdf');
const pdfPathAr = join(__dirname, 'ادوات-ومصطلحات-المشروع.pdf');
...
<head>
  <meta charset="UTF-8"/>
  <title>أدوات ومصطلحات مشروع مضياف العرب للفنادق</title>
  <style>
    ...
    h3 { color: #37474f; font-size: 11.5pt; page-break-after: avoid; }
    code {
      direction: ltr;
      unicode-bidi: embed;
    ...
    li { margin: 3px 0; }
    hr { border: none; border-top: 1px solid #b0bec5; margin: 16px 0; }
