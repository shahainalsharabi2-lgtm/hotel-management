/**
 * يولّد PDF من التقرير المعماري الكامل للمشروع
 * التشغيل: node docs/generate-project-full-report-pdf.mjs
 */
...
const mdPath = join(__dirname, 'تقرير-المشروع-الكامل.md');
const htmlPath = join(__dirname, 'project-full-report-ar.html');
const pdfPath = join(__dirname, 'Hotel-Project-Full-Report-AR.pdf');
const pdfPathAr = join(__dirname, 'تقرير-المشروع-الكامل.pdf');
...
<head>
  <meta charset="UTF-8"/>
  <title>تقرير مشروع مضياف العرب للفنادق — معمارية كاملة</title>
  <style>
