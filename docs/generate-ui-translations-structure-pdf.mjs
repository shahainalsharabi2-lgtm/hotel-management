/**
 * يولّد PDF من دليل هيكل الترجمة JSON والمحرر
 * التشغيل: node docs/generate-ui-translations-structure-pdf.mjs
 */
...
const mdPath = join(__dirname, 'دليل-هيكل-الترجمة-JSON-والمحرر.md');
const htmlPath = join(__dirname, 'ui-translations-structure-ar.html');
const pdfPath = join(__dirname, 'Hotel-UiTranslations-Structure-AR.pdf');
const pdfPathAr = join(__dirname, 'دليل-هيكل-الترجمة-JSON-والمحرر.pdf');
...
<head>
  <meta charset="UTF-8"/>
  <title>دليل هيكل الترجمة JSON والمحرر</title>
  <style>
