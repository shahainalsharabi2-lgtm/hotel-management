/**
 * يولّد PDF من ملخص المشروع
 * التشغيل: node docs/generate-project-summary-pdf.mjs
 */
...
const mdPath = join(__dirname, 'ملخص-المشروع.md');
const htmlPath = join(__dirname, 'project-summary-ar.html');
const pdfPath = join(__dirname, 'Hotel-Project-Summary-AR.pdf');
const pdfPathAr = join(__dirname, 'ملخص-المشروع.pdf');
...
<head>
  <meta charset="UTF-8"/>
  <title>ملخص مشروع مضياف العرب للفنادق</title>
  <style>
